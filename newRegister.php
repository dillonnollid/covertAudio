...
<head>
    ...
    <title>Create account - Musique</title>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
            ...
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                <form id="registerForm" action="newRegister.php" method="POST" class="w-full">
                    ...
                    <a class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue" href="./login.html">
                        Create account
                    </a>
