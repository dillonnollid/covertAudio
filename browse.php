                    ...
                    while($row = mysqli_fetch_array($songs)) {
                       ...
                       ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm"><a onclick='openPage("<?php echo '/album.php/' . $row['album'];?>")'><?php echo $tempAlbum->getTitle(); ?></a></td>
                            <td class="px-4 py-3 text-xs"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"><?php echo $row['genre'] ?></span></td>
