...
<div class="pageContainer md:flex-col md:p-12 space-y-8">
	...
	<form class="centeredContainer" action="includes/handlers/account-handler.php" method="post">
	...
	<form class="centeredContainer" action="includes/handlers/account-handler.php" method="post" enctype="multipart/form-data">
